...
interface BiEyeCrossedProps extends SVGProps<SVGSVGElement> {
  size?: number | number;
  color?: string;
}

const BiEyeCrossed: React.FC<BiEyeCrossedProps> = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
