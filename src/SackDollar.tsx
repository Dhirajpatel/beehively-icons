...
interface BiSackDollarProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const BiSackDollar: React.FC<BiSackDollarProps> = ({size = 24, color = "currentColor", ...props}) => (
