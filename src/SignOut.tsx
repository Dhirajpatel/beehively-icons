...
interface BiSignOutProps extends SVGProps<SVGSVGElement> {
  size?: number | number;
  color?: string;
}

const BiSignOut: React.FC<BiSignOutProps> = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
