...
interface BiUploadCloudProps extends SVGProps<SVGSVGElement> {
  size?: number | number;
  color?: string;
}

const BiUploadCloud: React.FC<BiUploadCloudProps> = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
