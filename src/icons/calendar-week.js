...
const CalendarWeek = forwardRef(({ color = 'currentColor', size = 24, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      <path
        d="M19,2h-1V1c0-0.5-0.4-1-1-1c-0.5,0-1,0.4-1,1v1H8V1c0-0.6-0.4-1-1-1C6.4,0,6,0.5,6,1v1H5C2.2,2,0,4.2,0,7v12
